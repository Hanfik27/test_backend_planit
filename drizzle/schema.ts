// ------------------------------------------------------
// drizzle/schema.ts — FINAL SUPER CLEAN (moved into server/)
// ------------------------------------------------------
...
export const userNotificationSettings = pgTable("user_notification_settings", {
  ...
  emailNotifications: integer("email_notifications").notNull().default(1), // 1 = ON, 0 = OFF

  taskDueReminder: integer("task_due_reminder").notNull().default(1),

  newTaskAssigned: integer("new_task_assigned").notNull().default(1),

  marketingEmails: integer("marketing_emails").notNull().default(0), // default OFF
